...
import { wishlistdata } from "../features/dataSlice";
import { membershipPlans } from "../features/dataSlice";
...
export default function Header(){
    ...
    const wishlist = async () => {
       const list = await axios.get('api/wishlist')
        dispatch(wishlistdata(list.data.productList))
    console.log(list.data.productList,'dddd')
